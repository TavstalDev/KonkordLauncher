...
namespace Tavstal.KonkordLauncher.Core.Managers
{
    public class AuthenticationManager
    {
        ...
        private static bool _wasAuthSuccessful;
        private static bool _wasAuthCancelled;
        #region Redirectors
