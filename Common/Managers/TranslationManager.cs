...
namespace Tavstal.KonkordLauncher.Common.Managers;
...
public static class TranslationManager
{
    ...
    public static async Task UpdateTranslations()
    {
        ...
        try
        {
            ...
            string defaultTranslationFile = Path.Combine(PathHelper.TranslationsDir, "en.json");
            ...
            if (settings != null)
            {
                ...
                if (File.Exists(localePath))
                {
                    ...
                    else
                    {
                        ...
                        _logger.Error("Failed to read the translation file, using default translations.");
                        _translations = DefaultTranslations;
                    }
                }
                else
