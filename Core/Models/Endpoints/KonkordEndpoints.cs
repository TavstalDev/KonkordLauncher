...
public static class KonkordEndpoints
{
    ...
    /// </summary>
    public const string LatestRelease = "https://api.github.com/repos/Tavstalt/Konkord/releases/latest";

    /// <summary>
    /// The URL for retrieving all releases of Konkord.
    /// </summary>
    public const string AllReleases = "https://api.github.com/repos/Tavstalt/Konkord/releases";
}