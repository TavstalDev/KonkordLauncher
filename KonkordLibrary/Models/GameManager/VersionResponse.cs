namespace KonkordLibrary.Models.GameManager
{
    public class VersionResponse
    {
        ...
        public VersionResponse(string vanillaVersion, string instanceVersion, string versionDirectory, string versionJsonPath, string versionJarPath, string gameDir)
        {
